      ...
      builder: (context, state) {
        ...
        return Directionality(
          ...
          child: SafeArea(
            ...
            title: Text("أذكار المسجد",style: TextStyle(color: Colors.brown),),
            centerTitle: true,
            shape: BeveledRectangleBorder(
              ...
              itemCount: controller.wordsmos.length,
                  ...
                  children: [
                    Container(
                      child: Column(
                        children: [
                          Text(
                            "${controller.wordsmos[index]['word']}",
                            style: TextStyle(
