      ...
      builder: (context, state) {
        ...
        return Directionality(
          ...
          child: SafeArea(
            ...
            title: Text("أذكار الصباح",style: TextStyle(color: Colors.brown),),
            centerTitle: true,
