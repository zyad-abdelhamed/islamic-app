...
class khtm extends StatelessWidget {
  const khtm({super.key});
      ...
      builder: (context, state) {
        ...
        return Directionality(
          ...
          child: SafeArea(
            ...
            title: Text(" ختم القران",style: TextStyle(color: Colors.brown),),
            centerTitle: true,
            shape: BeveledRectangleBorder(
              ...
              itemCount: controller.wordskh.length,
